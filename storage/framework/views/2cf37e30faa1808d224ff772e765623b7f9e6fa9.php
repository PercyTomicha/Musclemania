<?php $__env->startSection('content'); ?>
    ...
    <div class="ibox-content">
        <a href="<?php echo e(route('mensualidad.index')); ?>" class="btn btn-w-m btn-primary"><i class="fa fa-list-ol"></i>Listado de <strong>Mensualidades</strong></a>
        <div class="hr-line-dashed"></div>
        <?php echo Form::open(['route'=>['mensualidad.store'],'files'=>true,'method'=>'POST','class'=>'form-horizontal']); ?>
