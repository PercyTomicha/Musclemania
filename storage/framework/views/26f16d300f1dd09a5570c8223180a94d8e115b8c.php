...
<head>
    ...
    <title>Sistema del Instituto de Capacitación Popular | ICAP</title>
                ...
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div align="center" class="dropdown profile-element"> <span>
                            <img alt="image" class="img-circle" align="center" height="100" width="100" src="<?php echo e(asset('images/escudo-ICAP.png')); ?>" />
                             </span>
                            <span class="clear"> <span style="color:whitesmoke" class="block m-t-xs"> <strong class="font-bold">Instituto de Capacitacion Popular</strong></span></span>
                        </div>
                    ...
                    <li>
                        <a href="<?php echo e(route('nivel_academico.index')); ?>"><i class="fa fa-pie-chart"></i> <span class="nav-label">Nivel Académico</span>  </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('carrera.index')); ?>"><i class="fa fa-pie-chart"></i> <span class="nav-label">Carrera</span>  </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('ofertarCarrera.index')); ?>"><i class="fa fa-pie-chart"></i> <span class="nav-label">Ofertar Carrera</span>  </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('estudiante.index')); ?>"><i class="fa fa-pie-chart"></i> <span class="nav-label">Estudiante</span>  </a>
                    </li>
                    <li>
                        <a href="index.html"><i class="fa fa-th-large"></i> <span class="nav-label">Titulos</span> <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li class="active"><a href="<?php echo e(route('cargo.index')); ?>">Cargo</a></li>
                            <li><a href="<?php echo e(route('autoridad.index')); ?>">Autoridad</a></li>
                            <li><a href="<?php echo e(route('firmante.index')); ?>">Firmantes</a></li>
                            <li><a href="<?php echo e(route('titulo.index')); ?>">Titulos Emitidos</a></li>
                            <li><a href="<?php echo e(route('inscribe.index')); ?>">Titulados</a></li>
