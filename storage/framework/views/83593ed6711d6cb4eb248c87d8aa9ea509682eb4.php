            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <a href="<?php echo e(route('carrera.create')); ?>" class="btn btn-w-m btn-primary"><i class="fa fa-plus"></i> Agregar Nueva <strong>Carrera</strong></a>
                            ...
                            <table class="table table-striped table-bordered table-hover dataTables-example" >
                                ...
                                <?php $__currentLoopData = $carreras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="gradeX">
                                        ...
                                        <td><?php echo e($c->N); ?></td>
                                        <td><a class="btn btn-w-m btn-info" href="<?php echo e(route('carrera.edit',$c->id)); ?>"><i class="fa fa-edit"></i> Editar</a>
                                            <?php echo Form::open(['method' => 'DELETE','route' => ['carrera.destroy', $c->id],'style'=>'display:inline']); ?>
